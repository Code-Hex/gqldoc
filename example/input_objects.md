...
<table>
  ...
  <tr>
    <td><strong>excludedTeamMemberIds</strong> (<a href="http://example.com">[ID!]</a>)</td>
  ...
  <tr>
    <td><strong>notifyTeam</strong> (<a href="http://example.com">Boolean</a>)</td>
    <td><p>Notify the entire team of the PR if it is delegated</p></td>
  </tr>
  <tr>
    <td><strong>teamMemberCount</strong> (<a href="http://example.com">Int</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>field</strong> (<a href="http://example.com">PackageOrderField</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>field</strong> (<a href="http://example.com">SponsorableOrderField!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>repositoryIds</strong> (<a href="http://example.com">[ID!]</a>)</td>
    <td><p>A list of repository IDs to create as linked repositories for the project</p></td>
  </tr>
  <tr>
    <td><strong>template</strong> (<a href="http://example.com">ProjectTemplate</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>field</strong> (<a href="http://example.com">PullRequestOrderField!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>ipAllowListEntryId</strong> (<a href="http://example.com">ID!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>field</strong> (<a href="http://example.com">EnterpriseServerInstallationOrderField!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>includeAllBranches</strong> (<a href="http://example.com">Boolean</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>field</strong> (<a href="http://example.com">SavedReplyOrderField!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>field</strong> (<a href="http://example.com">ProjectOrderField!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>settingValue</strong> (<a href="http://example.com">EnterpriseMembersCanMakePurchasesSettingValue!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>invitee</strong> (<a href="http://example.com">String</a>)</td>
    <td><p>The login of a user to invite as an administrator.</p></td>
  </tr>
  <tr>
    <td><strong>role</strong> (<a href="http://example.com">EnterpriseAdministratorRole</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>field</strong> (<a href="http://example.com">EnterpriseAdministratorInvitationOrderField!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>discussionId</strong> (<a href="http://example.com">ID!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>field</strong> (<a href="http://example.com">EnterpriseServerUserAccountsUploadOrderField!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>actions</strong> (<a href="http://example.com">[CheckRunAction!]</a>)</td>
  ...
  <tr>
    <td><strong>completedAt</strong> (<a href="http://example.com">DateTime</a>)</td>
    <td><p>The time that the check run finished.</p></td>
  </tr>
  <tr>
    <td><strong>conclusion</strong> (<a href="http://example.com">CheckConclusionState</a>)</td>
    <td><p>The final conclusion of the check.</p></td>
  </tr>
  <tr>
    <td><strong>detailsUrl</strong> (<a href="http://example.com">URI</a>)</td>
    <td><p>The URL of the integrator&rsquo;s site that has the full details of the check.</p></td>
  </tr>
  <tr>
    <td><strong>externalId</strong> (<a href="http://example.com">String</a>)</td>
  ...
  <tr>
    <td><strong>output</strong> (<a href="http://example.com">CheckRunOutput</a>)</td>
  ...
  <tr>
    <td><strong>startedAt</strong> (<a href="http://example.com">DateTime</a>)</td>
    <td><p>The time that the check run began.</p></td>
  </tr>
  <tr>
    <td><strong>status</strong> (<a href="http://example.com">RequestableCheckStatusState</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>afterOid</strong> (<a href="http://example.com">GitObjectID!</a>)</td>
    <td><p>The value this ref should be updated to.</p></td>
  </tr>
  <tr>
    <td><strong>beforeOid</strong> (<a href="http://example.com">GitObjectID</a>)</td>
  ...
  <tr>
    <td><strong>name</strong> (<a href="http://example.com">GitRefname!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>checkSuiteId</strong> (<a href="http://example.com">ID!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>emoji</strong> (<a href="http://example.com">String</a>)</td>
  ...
  <tr>
    <td><strong>expiresAt</strong> (<a href="http://example.com">DateTime</a>)</td>
    <td><p>If set, the user status will not be shown after this date.</p></td>
  </tr>
  <tr>
    <td><strong>limitedAvailability</strong> (<a href="http://example.com">Boolean</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>bodyVersion</strong> (<a href="http://example.com">String</a>)</td>
...
will be rejected if the given version does not match the latest version on the server.</p></td>
  ...
  <tr>
    <td><strong>pinned</strong> (<a href="http://example.com">Boolean</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>autoInactive</strong> (<a href="http://example.com">Boolean</a>)</td>
...
status&rsquo;s deployment.</p></td>
  ...
  <tr>
    <td><strong>deploymentId</strong> (<a href="http://example.com">ID!</a>)</td>
  ...
  <tr>
    <td><strong>environment</strong> (<a href="http://example.com">String</a>)</td>
    <td><p>If provided, updates the environment of the deploy. Otherwise, does not modify the environment.</p></td>
  </tr>
  <tr>
    <td><strong>environmentUrl</strong> (<a href="http://example.com">String</a>)</td>
    <td><p>Sets the URL for accessing your environment.</p></td>
  </tr>
  <tr>
    <td><strong>logUrl</strong> (<a href="http://example.com">String</a>)</td>
...
historical information for what happened in the deployment.</p></td>
  ...
  <tr>
    <td><strong>state</strong> (<a href="http://example.com">DeploymentStatusState!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>field</strong> (<a href="http://example.com">TeamOrderField!</a>)</td>
    <td><p>The field in which to order nodes by.</p></td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td><strong>state</strong> (<a href="http://example.com">SubscriptionState!</a>)</td>
    <td><p>The new state of the subscription.</p></td>
  </tr>
  <tr>
    <td><strong>subscribableId</strong> (<a href="http://example.com">ID!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>websiteUrl</strong> (<a href="http://example.com">String</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>columnImports</strong> (<a href="http://example.com">[ProjectColumnImport!]!</a>)</td>
  ...
  <tr>
    <td><strong>ownerName</strong> (<a href="http://example.com">String!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>autoMerge</strong> (<a href="http://example.com">Boolean</a>)</td>
  ...
  <tr>
    <td><strong>requiredContexts</strong> (<a href="http://example.com">[String!]</a>)</td>
...
contexts, pass an empty array. Defaults to all unique contexts.</p></td>
  ...
  <tr>
    <td><strong>task</strong> (<a href="http://example.com">String</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>assignee</strong> (<a href="http://example.com">String</a>)</td>
...
user, and <code>*</code> for issues assigned to any user.</p></td>
  ...
  <tr>
    <td><strong>createdBy</strong> (<a href="http://example.com">String</a>)</td>
    <td><p>List issues created by given name.</p></td>
  </tr>
  <tr>
    <td><strong>labels</strong> (<a href="http://example.com">[String!]</a>)</td>
    <td><p>List issues where the list of label names exist on the issue.</p></td>
  </tr>
  <tr>
    <td><strong>mentioned</strong> (<a href="http://example.com">String</a>)</td>
    <td><p>List issues where the given name is mentioned in the issue.</p></td>
  </tr>
  <tr>
    <td><strong>milestone</strong> (<a href="http://example.com">String</a>)</td>
...
<code>null</code> for issues with no milestone, and <code>*</code> for issues that are assigned to any milestone.</p></td>
  ...
  <tr>
    <td><strong>since</strong> (<a href="http://example.com">DateTime</a>)</td>
    <td><p>List issues that have been updated at or after the given date.</p></td>
  </tr>
  <tr>
    <td><strong>states</strong> (<a href="http://example.com">[IssueState!]</a>)</td>
    <td><p>List issues filtered by the list of states given.</p></td>
  </tr>
  <tr>
    <td><strong>viewerSubscribed</strong> (<a href="http://example.com">Boolean</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>type</strong> (<a href="http://example.com">SecurityAdvisoryIdentifierType!</a>)</td>
    <td><p>The identifier type.</p></td>
  </tr>
  <tr>
    <td><strong>value</strong> (<a href="http://example.com">String!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>annotationLevel</strong> (<a href="http://example.com">CheckAnnotationLevel!</a>)</td>
    <td><p>Represents an annotation&rsquo;s information level</p></td>
  </tr>
  <tr>
    <td><strong>location</strong> (<a href="http://example.com">CheckAnnotationRange!</a>)</td>
  ...
  <tr>
    <td><strong>rawDetails</strong> (<a href="http://example.com">String</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>membersCanCreateInternalRepositories</strong> (<a href="http://example.com">Boolean</a>)</td>
    <td><p>Allow members to create internal repositories. Defaults to current value.</p></td>
  </tr>
  <tr>
    <td><strong>membersCanCreatePrivateRepositories</strong> (<a href="http://example.com">Boolean</a>)</td>
    <td><p>Allow members to create private repositories. Defaults to current value.</p></td>
  </tr>
  <tr>
    <td><strong>membersCanCreatePublicRepositories</strong> (<a href="http://example.com">Boolean</a>)</td>
    <td><p>Allow members to create public repositories. Defaults to current value.</p></td>
  </tr>
  <tr>
    <td><strong>membersCanCreateRepositoriesPolicyEnabled</strong> (<a href="http://example.com">Boolean</a>)</td>
    <td><p>When false, allow member organizations to set their own repository creation member privileges.</p></td>
  </tr>
  <tr>
    <td><strong>settingValue</strong> (<a href="http://example.com">EnterpriseMembersCanCreateRepositoriesSettingValue</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>afterColumnId</strong> (<a href="http://example.com">ID</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>field</strong> (<a href="http://example.com">SecurityAdvisoryOrderField!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>field</strong> (<a href="http://example.com">TeamRepositoryOrderField!</a>)</td>
    <td><p>The field to order repositories by.</p></td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td><strong>field</strong> (<a href="http://example.com">LabelOrderField!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>field</strong> (<a href="http://example.com">ReactionOrderField!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>projectCardId</strong> (<a href="http://example.com">ID!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>digestMethod</strong> (<a href="http://example.com">SamlDigestAlgorithm!</a>)</td>
  ...
  <tr>
    <td><strong>idpCertificate</strong> (<a href="http://example.com">String!</a>)</td>
    <td><p>The x509 certificate used by the identity provider to sign assertions and responses.</p></td>
  </tr>
  <tr>
    <td><strong>issuer</strong> (<a href="http://example.com">String</a>)</td>
    <td><p>The Issuer Entity ID for the SAML identity provider</p></td>
  </tr>
  <tr>
    <td><strong>signatureMethod</strong> (<a href="http://example.com">SamlSignatureAlgorithm!</a>)</td>
    <td><p>The signature algorithm used to sign SAML requests for the identity provider.</p></td>
  </tr>
  <tr>
    <td><strong>ssoUrl</strong> (<a href="http://example.com">URI!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>annotations</strong> (<a href="http://example.com">[CheckAnnotationData!]</a>)</td>
    <td><p>The annotations that are made as part of the check run.</p></td>
  </tr>
  <tr>
    <td><strong>images</strong> (<a href="http://example.com">[CheckRunOutputImage!]</a>)</td>
    <td><p>Images attached to the check run output displayed in the GitHub pull request UI.</p></td>
  </tr>
  <tr>
    <td><strong>summary</strong> (<a href="http://example.com">String!</a>)</td>
    <td><p>The summary of the check run (supports Commonmark).</p></td>
  </tr>
  <tr>
    <td><strong>text</strong> (<a href="http://example.com">String</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>canonicalId</strong> (<a href="http://example.com">ID!</a>)</td>
  ...
  <tr>
    <td><strong>duplicateId</strong> (<a href="http://example.com">ID!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>comments</strong> (<a href="http://example.com">[DraftPullRequestReviewComment]</a>)</td>
  ...
  <tr>
    <td><strong>event</strong> (<a href="http://example.com">PullRequestReviewEvent</a>)</td>
  ...
  <tr>
    <td><strong>threads</strong> (<a href="http://example.com">[DraftPullRequestReviewThread]</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>adminLogins</strong> (<a href="http://example.com">[String!]!</a>)</td>
    <td><p>The logins for the administrators of the new organization.</p></td>
  </tr>
  <tr>
    <td><strong>billingEmail</strong> (<a href="http://example.com">String!</a>)</td>
  ...
  <tr>
    <td><strong>profileName</strong> (<a href="http://example.com">String!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>topicNames</strong> (<a href="http://example.com">[String!]!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>autoTriggerPreferences</strong> (<a href="http://example.com">[CheckSuiteAutoTriggerPreference!]!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>field</strong> (<a href="http://example.com">EnterpriseServerUserAccountOrderField!</a>)</td>
...
<table>
  ...
  <tr>
    <td><strong>checkRunId</strong> (<a href="http://example.com">ID!</a>)</td>
